...
export class GoogleWorkspaceClient {
  ...
  async updateDocument(documentId: string, content: string): Promise<DocumentInfo> {
  ...
  async appendToDocument(documentId: string, content: string): Promise<DocumentInfo> {
    const doc = await this.docs.documents.get({ documentId });
    const endIndex = this.getDocumentEndIndex(doc.data);
